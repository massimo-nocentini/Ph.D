...
\item[26/11/2015] a lecture for \href{http://www.unifi.it/index.php?module=ofform2\&mode=1\&cmd=3\&AA=2015\&afId=426024}
    {B018968 - PROGETTAZIONE E ANALISI DI ALGORITMI} course, 3 hours. Content: an introduction to 
    \href{http://www.sympy.org/en/index.html}{SymPy}, covered object and meta language, basic symbolic 
    manipulations, Taylor series expansions, Fibonacci numbers and solved Quicksort's swap recurrence
    in the average case. We provided a \emph{notebook} in \href{http://jupyter.org/}{Jupyter} jargon, available 
    at \href{https://github.com/massimo-nocentini/PhD/tree/master/courses/paa}{my PhD repo} and browseable
    on line through \href{http://nbviewer.jupyter.org/github/massimo-nocentini/PhD/blob/master/courses/paa/sympy-notebook/an-introduction-to-sympy.ipynb?flush\_cache=true}{Jupyter viewer}.
